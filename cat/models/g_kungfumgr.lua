...
local _Meta = { g_csv_id = 0 , name = 0 , csv_id = 0 , level = 0, iconid = 0 , skill_descp = 0 , skill_effect = 0 , type = 0 , harm_type = 0 , arise_probability = 0 , arise_count = 0 , arise_type = 0 , arise_param = 0 , attack_type = 0 , effect_percent = 0 , addition_effect_type = 0 , addition_prog = 0 , equip_buff_id = 0, buff_id = 0 , prop_csv_id = 0 , prop_num = 0 , currency_type = 0 , currency_num = 0 }
