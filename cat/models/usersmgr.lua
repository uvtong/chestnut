...
local _Meta = { id=0, uname=0, uviplevel=0, uexp=0, config_sound=0, config_music=0, avatar=0, sign=0, c_role_id=0, ifonline=0, level=0, combat=0, defense=0, critical_hit=0, modify_uname_count=0, recharge_total=0, recharge_vip=0, u_recharge_reward=0 }
