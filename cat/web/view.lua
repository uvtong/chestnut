...
function VIEW.index()
	...
	function R:__get()
		...
		--for i = 1 , 100 do
			...
			skynet.send(".channel", "lua", "send_email_to_group" , { type = 2 , title = "hello" , content = "world" , itemsn1 = 1 , itemnum1 = 10000 , itemsn2 = 2 , itemnum2 = 10000 , itemsn3 = 3 , itemnum3 = 10000 , iconid = 10001 }  , { { csv_id = 117 } } )
		--end
