package.cpath = "./../../3rd/lua-socket/?.so;./../../3rd/skynet/luaclib/?.so;"
package.path = "./../../3rd/lualib/?.lua;./../../3rd/skynet-client/?lua"

--local socket = require "clientsocket"
local socket = require "packagesocket"
...
local PROTOCOL_UDPv6 = 2

--recode package fen ge fu
local HEADER_LINE = 0
local HEADER_PG = 1
...
local gate = assert(socket.new())
print(type(gate))
local sock = assert(socket.socket(gate, PROTOCOL_TCP, 0, HEADER_LINE))
print(sock)
