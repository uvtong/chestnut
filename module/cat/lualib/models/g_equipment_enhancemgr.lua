...
function cls:ctor( ... )
	...
	self.__head_ord[9] = self.__head["combat_probability"]
	self.__head_ord[10] = self.__head["defense_probability"]
	self.__head_ord[11] = self.__head["critical_hit_probability"]
